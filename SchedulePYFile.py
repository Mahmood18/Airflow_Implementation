...
default_args = {
    ...
    'email': ['sheikhmahmood.tmc@gmail.com'],
...
dag = DAG(
    ...
    description='This contains code to scrape lush website',
...
def scrapelush():
    ...
    data.to_excel("LushProducts.xlsx",sheet_name='sheet1',index=False)
    print("DONE")
